...
public class Base64 {
     ...
     * @since 1.4
     */
    public static String encodeBytes( byte[] source, boolean breakLines)throws Exception
    {
    ...
    public static String encodeBytes( byte[] source, int off, int len, boolean breakLines)throws Exception
    {
        ...
        return new String( outBuff, 0, e ,"iso-8859-1");//iso-8859-1
    }   // end encodeBytes
     ...
     * @since 1.3
     */
    public static String encodeString( String s, boolean breakLines ,String charset)
            throws Exception
    {
